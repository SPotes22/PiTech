# Copyright (c) 2025 PiTech / SPotes22
# This file is part of PiTech and is licensed under the GNU General Public License v3.0.
# See the LICENSE file distributed with this work for full terms.
